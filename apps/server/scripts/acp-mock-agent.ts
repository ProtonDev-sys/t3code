...
const argvLogPath = process.env.T3_ACP_ARGV_LOG_PATH;
...
const promptResponseText =
  process.env.T3_ACP_PROMPT_RESPONSE_TEXT ??
  (process.env.T3_ACP_PROMPT_RESPONSE_TEXT_B64
    ? Buffer.from(process.env.T3_ACP_PROMPT_RESPONSE_TEXT_B64, "base64").toString("utf8")
    : undefined);
